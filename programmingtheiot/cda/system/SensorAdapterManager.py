...
class SensorAdapterManager(object):
	...
	def __init__(self):
		...
		# Setup the scheduler
		# coalesce=True prevents job build-up if execution is delayed
		...
		# Encapsulate sensor task creation
	...
	def startManager(self):
		"""
		Starts the SensorAdapterManager and its scheduler.
		"""
	...
	def stopManager(self):
		"""
		Stops the SensorAdapterManager and its scheduler.
		"""
